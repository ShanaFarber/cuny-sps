...
# load ACS data
census_ny <- get_acs(geography = "tract",
                  variables = c(total_pop = "B01001_001",
                                ...
                                median_household_income = "B22008_001",
...
census_ca <- get_acs(geography = "tract",
                     variables = c(total_pop = "B01001_001",
                                   total_male = "B01001_002",
                                   male_18to19 = "B01001_007",
                                   male_20 = "B01001_008",
...
# save as .RData
save(census_ny, census_ca, file = "data/acs_master.RData")
