...
Here I figured out how to perform LU factorization on matrix A, using the matrix from the lecture as a guide:
...
I then tested the function to make sure it works properly. 
