...
```{r}
israeli_vaccination <- read.csv("C:/Users/Shoshana/Documents/CUNY SPS/cuny-sps/DATA_607/israeli_vaccination_ec/israeli_vaccination_data_analysis_start.csv", na.strings = c("", " "))
```
